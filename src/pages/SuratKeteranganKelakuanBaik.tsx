...
const SuratKeteranganKelakuanBaik = () => {
  ...
  const sendData = (e: React.FormEvent) => {
    ...
    axios
      .post(`${import.meta.env.VITE_API_URL}/surat_keterangan_kelakuan_baik/create`, {
        ...
        <form className="card shadow p-4" onSubmit={sendData}>
          ...
          <div className="mb-3">
            ...
            <input
              ...
              className="form-control rounded-4 py-2"
              id="keperluan"
              placeholder="Sekolah / Pekerjaan / Lainnya"
...
export default SuratKeteranganKelakuanBaik;
